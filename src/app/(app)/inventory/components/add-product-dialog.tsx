  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-3xl">
        {/* Gradient Header */}
        <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-r from-amber-500 to-amber-600 rounded-t-lg flex items-center px-6">
        ...
        <div className="pt-12 max-h-[75vh] overflow-y-auto pr-2">
          ...
          <div className="bg-amber-50/50 dark:bg-amber-950/20 rounded-lg p-6 mb-4">
            <div className="flex items-center gap-2 mb-4">
              <PhilippinePeso className="w-5 h-5 text-amber-600" />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label htmlFor="cost" className="flex items-center gap-2 text-sm">
                  <PhilippinePeso className="w-4 h-4 text-amber-600" />
                  Cost
                </Label>
          ...
          <div className="bg-amber-50/50 dark:bg-amber-950/20 rounded-lg p-6 mb-4">
            ...
            <div className="grid gap-2">
              <div className="border-2 border-dashed border-amber-300 dark:border-amber-700 rounded-md p-6 text-center bg-white dark:bg-gray-950">
                <Input
                  id="images"
                  type="file"
                  multiple
                ...
                <Label htmlFor="images" className="cursor-pointer">
                  <ImageIcon className="mx-auto h-12 w-12 text-amber-500" />
                  <span className="mt-2 block text-sm font-medium text-amber-600 dark:text-amber-400">Click to upload images</span>
                </Label>
              </div>
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  {imagePreviews.map((preview, index) => (
                    <div key={index} className="relative">
                      <img src={preview} alt={`Preview ${index}`} className="w-full h-24 object-cover rounded-md border-2 border-amber-200 dark:border-amber-800" />
                      <Button
                        variant="destructive"
                        size="icon"
