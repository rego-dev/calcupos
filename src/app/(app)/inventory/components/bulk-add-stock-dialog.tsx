                        ...
                        <div className="bg-gradient-to-r from-zinc-100 to-zinc-200 dark:from-zinc-900/20 dark:to-zinc-800/20 p-4 border-b-2 border-zinc-300 dark:border-zinc-700/50">
                            <div className="relative flex-1">
                                ...
                                <Input
                                    ...
                                    className="pl-10 h-11 border-2 focus:border-zinc-400"
                                    value={searchTerm}
                                    onChange={(e) => setSearchTerm(e.target.value)}
                                />
                            </div>
                            <div className="mt-3 text-sm text-zinc-600 dark:text-zinc-400 font-medium">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="font-semibold text-base text-zinc-900 dark:text-zinc-100 truncate">{product.name}</p>
                    ...
                    <div className="flex flex-col rounded-xl shadow-sm border-2 border-zinc-200 dark:border-zinc-800 h-full min-h-0 overflow-hidden bg-white dark:bg-zinc-950">
                        {selectedProducts.length === 0 ? (
                            <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-zinc-50 to-amber-50/30">
                                ...
                                <h3 className="text-xl font-bold text-zinc-900 mb-2">No Products Selected</h3>
                                ...
                                <ScrollArea className="flex-1 min-h-0 bg-gradient-to-br from-zinc-50/50 to-amber-50/20 dark:from-zinc-900/50 dark:to-amber-900/10">
                                    <div className="p-4 space-y-3">
                                        {selectedProducts.map((item) => (
                                            <div
                                                key={item.product.id}
                                                className="bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-800 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow"
                                            >
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="font-semibold text-sm text-zinc-900 dark:text-zinc-100 truncate mb-1">
                                                            {item.product.name}
                                                        </p>
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            <div className="flex items-center bg-zinc-100 dark:bg-zinc-800 rounded-lg border-2 border-zinc-200 dark:border-zinc-700">
                                                                <Button
                                                                    variant="ghost"
                                                                    size="sm"
                                                                    onClick={(e) => {
                                                                    ...
                                                                    className="h-9 w-9 p-0 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-l-md"
                                                                >
                                                                ...
                                                                <Button
                                                                    ...
                                                                    className="h-9 w-9 p-0 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-r-md"
                                                                >
                ...
                <div className="px-6 pb-6">
                    <div className="flex gap-3">
                        <Button
                            variant="outline"
                            onClick={handleClose}
                            className="flex-1 h-11 border-2 hover:bg-zinc-100"
                            disabled={isLoading}
                        >
                            Cancel
                        </Button>
